        ...
        <div>
            {forecasts && (
                <>
                    ...
                    {forecasts.forecastsTomorrow.length > 0 && (<div className="tomorrow">
                    ...
                    {forecasts.forecastsDay3.length > 0 && (<div className="day3">
                    ...
                    {forecasts.forecastsDay4.length > 0 && (<div className="day4">
                    ...
                    {forecasts.forecastsDay5.length > 0 && (
                        <div className="day5">
