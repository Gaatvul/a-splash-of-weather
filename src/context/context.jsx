...
import {
    WiStormShowers, WiDaySprinkle, WiShowers, WiSnow,
    WiWindy, WiSmoke, WiDayHaze, WiFog, WiSandstorm, WiDust,
    WiStrongWind, WiTornado, WiDaySunny, WiCloudy
} from "react-icons/wi";
...
const AppProvider = ({ children }) => {
    ...
    const formatTimestamp = (UNIXTimestamp) => {
        return new Date(UNIXTimestamp * 1000).toLocaleDateString("en-GB", { weekday: "long", day: "numeric", month: "short", year: "numeric" })
    ...
    const JSONToMap = () => {
        for (const country of JSONCountryCodes) {
            const { Code, Name } = country
            countryCodes.set(Code, Name)
        }
    }
    JSONToMap()
